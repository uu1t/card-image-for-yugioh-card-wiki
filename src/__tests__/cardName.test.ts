...
describe('parse()', () => {
  ...
  it('extracts Japanese and English names', () => {
    assertParsed(require('./fixtures/h2-blue-eyes-white-dragon.html'), '青眼の白龍', 'Blue-Eyes White Dragon')
  })
  ...
  it('extracts Japanese name when there is no English name', () => {
    assertParsed(require('./fixtures/h2-ddd-hexblood-king-siegfried.html'), 'ＤＤＤ呪血王サイフリート', null)
  })
